...
async def raport_command(ctx):
    ...
    """
    try:
        # Import systemu raportów - NOWY WARSZTATOWY!
        from workshop.raport_system_workshop import RaportSystemWorkshop
        ...
        raport_system = RaportSystemWorkshop(
            ...
            demo_mode=True  # BEZPIECZNY TRYB DEMO - nie zużywa quota!
        )
